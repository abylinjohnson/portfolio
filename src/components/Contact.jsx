import {
  ...
  export default function Contact() {
    const { hasCopied, onCopy } = useClipboard('jgabylin@karunya.edu.in');
            ...
            <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
              ...
              <Stack
                ...
                <Stack
                  ...
                  <Link target="_blank" rel="noopener noreferrer"  href="https://github.com/abylinjohnson">
                    <IconButton
                      aria-label="github"
                      variant="ghost"
                      size="lg"
                  ...
                  <Link target="_blank" rel="noopener noreferrer" href="https://twitter.com/_teahol1c">
                    <IconButton
                      aria-label="twitter"
                      variant="ghost"
                      size="lg"
                  ...
                  <Link target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/abylinjohnson">
                    <IconButton
                      aria-label="linkedin"
                      variant="ghost"
                      size="lg"
